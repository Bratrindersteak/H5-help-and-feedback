 ...
 *   @version    : 1.0.1
 *   @update-log :
 *                 1.0.1 - 20150325 陈  龙 localStorage工具类
 *
 **/
!function (global) {
    ...
    if (isLocalStorageNameSupported()) {
         ...
         */
        store.setItem = store.set = function (key, val) {
            if (val === undefined) {
         ...
         */
        store.getItem = store.get = function (key) {
    ...
    store.getStorage = function () {
        try {
            ...
            typeof console !== 'undefined' && typeof console.log === 'function' && console.log('localStorage is not supported');
        }
