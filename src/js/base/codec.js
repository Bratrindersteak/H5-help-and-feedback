...
(function (global) {
     ...
     */
    var ppEncode = function (input) {
        var str1 = encodeURL(input);
        var str64 = base64encode(utf8Encode(str1));
        return str64;
    }
    /**
     * 解码sohupassport
     ...
     * @return {String}       原始字符串
     */
    var ppDecode = function (str64) {
        str64 = decodeUrl(str64);
        str64 = str64.replace(/[^A-Za-z0-9\+\/\=]/g, "");
        var str1 = utf8Decode(base64decode(str64));
        return str1;
    }
    /**
    *解码 sohuad decode
    ...
    */
    ...
    var encodeURL= function(str) { // the following method make the Base64
        // method url safe
    ...
    var Codec = {
        ...
        ppDecode:ppDecode,
        /**
         * @memberof BaseCodec ad
         * @summary 将一个字符串用base64解密，并转换为
         * utf16->utf8->base64->str
         * @type {function}
         * @param  {string}  str                            - 要转换的字符串
         * @return {string}                                 - 转换后的字符串
         */
